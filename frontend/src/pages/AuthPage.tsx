...
const GOOGLE_OAUTH_STATE_STORAGE_KEY = "CodeMaster-google-oauth-state";
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <img src="/logo.png" alt="Loading" className="w-8 h-8 object-contain animate-spin" />
      </div>
    );
  }
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="flex items-center gap-2 mb-10 lg:hidden">
            <img src="/logo.png" alt="CodeMaster Logo" className="w-6 h-6 object-contain" />
            <span className="text-xl font-semibold tracking-tight">CodeMaster</span>
          </div>
