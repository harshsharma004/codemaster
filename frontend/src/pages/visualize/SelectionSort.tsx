...
type BarState = "idle" | "comparing" | "min" | "swapping" | "sorted";
    ...
    <div className="flex flex-1 flex-col bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/5 via-background to-secondary/20 w-full">
      <div className="w-full max-w-5xl mx-auto px-6 pt-6 pb-16 space-y-6">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">Selection Sort</h1>
            <p className="text-sm text-muted-foreground">Finds the minimum element from the unsorted part and puts it at the beginning.</p>
          </div>
        </motion.div>
        ...
        <div className="p-4 rounded-2xl bg-card border-2 border-border shadow-sm" style={{ minHeight: 320 }}>
        ...
        <div className="p-4 rounded-2xl bg-card border-2 border-border shadow-sm space-y-4">
