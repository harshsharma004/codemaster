...
import (
	...
	"CodeMaster/backend/internal/apperror"
	"CodeMaster/backend/internal/googleoauth"
	"CodeMaster/backend/internal/model"
	"CodeMaster/backend/internal/security"
	"CodeMaster/backend/internal/validation"
)
...
func (api *API) docsPage(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`<!doctype html><html><body><h1>CodeMaster API Docs</h1><p>Use <a href="/openapi.json">/openapi.json</a> for the generated contract placeholder.</p></body></html>`))
}
